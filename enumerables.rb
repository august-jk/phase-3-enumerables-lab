...
def print_spicy_foods(spicy_foods)
  # your code here
  spicy_foods_with_emoji = spicy_foods.map do |food| 
    "#{food[:name]} (#{food[:cuisine]}) | Heat Level: #{"🌶" * food[:heat_level]}"
  end
  puts spicy_foods_with_emoji
end
...
def print_spiciest_foods(spicy_foods)
 ...
 spiciest_foods_with_emoji = spiciest_foods.map do |food| 
    "#{food[:name]} (#{food[:cuisine]}) | Heat Level: #{"🌶" * food[:heat_level]}"
  end
  puts spiciest_foods_with_emoji
end
